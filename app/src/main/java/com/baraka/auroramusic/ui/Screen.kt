...
sealed class Screen(val route: String, val label: String, val icon: Int) {
    ...
    object Settings : Screen("settings", "Settings", com.baraka.auroramusic.R.drawable.ic_aurora_note) 
    object About : Screen("about", "About", com.baraka.auroramusic.R.drawable.ic_aurora_note)
}
